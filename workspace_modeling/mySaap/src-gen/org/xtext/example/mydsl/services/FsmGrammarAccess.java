...
public class FsmGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class StateMachineElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fsm.StateMachine");
		...
		private final RuleCall cStateStateParserRuleCall_4_0_0 = (RuleCall)cStateAssignment_4_0.eContents().get(0);
		...
		//State
		public RuleCall getStateStateParserRuleCall_4_0_0() { return cStateStateParserRuleCall_4_0_0; }
	...
	public class StateElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fsm.State");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//State:
		//	{State} 'State' name=EString default?='default'?;
		@Override public ParserRule getRule() { return rule; }
	...
	public class TransitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fsm.Transition");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final CrossReference cToStateCrossReference_6_0 = (CrossReference)cToAssignment_6.eContents().get(0);
		private final RuleCall cToStateEStringParserRuleCall_6_0_1 = (RuleCall)cToStateCrossReference_6_0.eContents().get(1);
		...
		//[State|EString]
		public CrossReference getToStateCrossReference_6_0() { return cToStateCrossReference_6_0; }
		
		//EString
		public RuleCall getToStateEStringParserRuleCall_6_0_1() { return cToStateEStringParserRuleCall_6_0_1; }
		
		//'}'
		public Keyword getRightCurlyBracketKeyword_7() { return cRightCurlyBracketKeyword_7; }
	}
	public class EStringElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fsm.EString");
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.xtext.example.mydsl.Fsm".equals(grammar.getName())) {
				return grammar;
			}
