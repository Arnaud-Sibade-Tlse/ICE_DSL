...
public class FsmGenerator extends AbstractGenerator {
  private final String DEFAULT_PACKAGE = "saap.Xtend.main";
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    this.stateMachine.getState().forEach(_function);
    final Consumer<Transition> _function_1 = (Transition tr) -> {
      String _firstUpper = StringExtensions.toFirstUpper(tr.getName());
      String _plus = ((this.DEFAULT_PATH + "/") + _firstUpper);
      String _plus_1 = (_plus + ".java");
      fsa.generateFile(_plus_1, this.print(tr));
    };
    this.stateMachine.getTransition().forEach(_function_1);
  ...
  public CharSequence print(final StateMachine stateMachine) {
    CharSequence _xblockexpression = null;
    {
      String stateMachineUpper = StringExtensions.toFirstUpper(stateMachine.getName());
      String stateMachineLower = StringExtensions.toFirstLower(stateMachine.getName());
      ...
      _builder.append(stateMachineUpper);
      _builder.append(" {");
      _builder.newLineIfNotEmpty();
      _builder.newLine();
      _builder.append("\t");
      ...
      _builder.newLine();
      _builder.append("\t");
      this.initializeFSM(stateMachine);
      _builder.newLineIfNotEmpty();
      _builder.append("\t");
      _builder.newLine();
      _builder.append("\t");
      ...
      _builder.newLineIfNotEmpty();
      {
        ...
        for(final State state : _state) {
          {
            boolean _isDefault = state.isDefault();
            if (_isDefault) {
              _builder.append("\t\t");
      ...
      _builder.append(stateMachineUpper, "\t\t");
      _builder.append(" ");
      _builder.append(stateMachineLower, "\t\t");
      _builder.append(" = new ");
  ...
  public CharSequence printGetterAndSetter(final String string, final String string2) {
    CharSequence _xblockexpression = null;
    {
      final String attributeNameUpper = StringExtensions.toFirstUpper(string2);
      final String attributeNameLower = StringExtensions.toFirstLower(string2);
      final String typeUpper = StringExtensions.toFirstUpper(string);
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("/**");
      _builder.newLine();
      _builder.append(" ");
  ...
  public void initializeFSM(final StateMachine machine) {
    InputOutput.<String>println("hello");
  }
  
  public CharSequence print(final State state) {
    CharSequence _xblockexpression = null;
    {
      String stateName = StringExtensions.toFirstUpper(state.getName());
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("package ");
      _builder.append(this.DEFAULT_PACKAGE);
      _builder.append(";");
  ...
  public CharSequence print(final Transition transition) {
    CharSequence _xblockexpression = null;
    {
      String transitionName = StringExtensions.toFirstUpper(transition.getName());
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("package ");
      _builder.append(this.DEFAULT_PACKAGE);
      _builder.append(";");
      ...
      _builder.newLine();
      _builder.append("public class ");
      _builder.append(transitionName);
      _builder.append(" extends State {");
      _builder.newLineIfNotEmpty();
      _builder.append("\t");
      _builder.newLine();
      ...
      _builder.append("\t\t");
      _builder.append("this.setName(\"");
      String _firstLower = StringExtensions.toFirstLower(transitionName);
      _builder.append(_firstLower, "\t\t");
      _builder.append("\");");
      _builder.newLineIfNotEmpty();
      _builder.append("\t");
