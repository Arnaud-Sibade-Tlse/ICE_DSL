 ...
 * @generated
 */
public class SAAPPackageImpl extends EPackageImpl implements SAAPPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see sAAP.SAAPPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private SAAPPackageImpl() {
		super(eNS_URI, SAAPFactory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static SAAPPackage init() {
		if (isInited)
		...
		theSAAPPackage.createPackageContents();

		// Initialize created meta-data
		theSAAPPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theSAAPPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(SAAPPackage.eNS_URI, theSAAPPackage);
		return theSAAPPackage;
	}
	 ...
	 * @generated
	 */
	public SAAPFactory getSAAPFactory() {
		return (SAAPFactory) getEFactoryInstance();
	}
