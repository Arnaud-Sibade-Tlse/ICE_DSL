...
/**
 * This is the item provider adapter for a {@link stateMachineDoItYourself.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addOutgoingPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Transition_outgoing_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_outgoing_feature",
								"_UI_Transition_type"),
						StateMachineDoItYourselfPackage.Literals.TRANSITION__OUTGOING, true, false, true, null, null,
						null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_incoming_feature",
								"_UI_Transition_type"),
						StateMachineDoItYourselfPackage.Literals.TRANSITION__INCOMING, true, false, true, null, null,
						null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_name_feature",
								"_UI_Transition_type"),
						StateMachineDoItYourselfPackage.Literals.TRANSITION__NAME, true, false, false,
