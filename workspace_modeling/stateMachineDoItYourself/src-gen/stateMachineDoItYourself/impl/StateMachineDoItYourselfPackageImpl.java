 ...
 * @generated
 */
public class StateMachineDoItYourselfPackageImpl extends EPackageImpl implements StateMachineDoItYourselfPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see stateMachineDoItYourself.StateMachineDoItYourselfPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private StateMachineDoItYourselfPackageImpl() {
		super(eNS_URI, StateMachineDoItYourselfFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link StateMachineDoItYourselfPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static StateMachineDoItYourselfPackage init() {
		if (isInited)
			return (StateMachineDoItYourselfPackage) EPackage.Registry.INSTANCE
					.getEPackage(StateMachineDoItYourselfPackage.eNS_URI);

		// Obtain or create and register package
		StateMachineDoItYourselfPackageImpl theStateMachineDoItYourselfPackage = (StateMachineDoItYourselfPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof StateMachineDoItYourselfPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
						: new StateMachineDoItYourselfPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theStateMachineDoItYourselfPackage.createPackageContents();

		// Initialize created meta-data
		theStateMachineDoItYourselfPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theStateMachineDoItYourselfPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(StateMachineDoItYourselfPackage.eNS_URI, theStateMachineDoItYourselfPackage);
		return theStateMachineDoItYourselfPackage;
	}
	 ...
	 * @generated
	 */
	public EOperation getStateMachine__Execute() {
	 ...
	 * @generated
	 */
	public StateMachineDoItYourselfFactory getStateMachineDoItYourselfFactory() {
		return (StateMachineDoItYourselfFactory) getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEOperation(getStateMachine__Execute(), null, "execute", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(stateEClass, State.class, "State", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getState_From(), this.getTransition(), this.getTransition_Outgoing(), "from", null, 1, 1,
		...
		initEClass(transitionEClass, Transition.class, "Transition", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTransition_Outgoing(), this.getState(), this.getState_From(), "outgoing", null, 0, -1,
...
} //StateMachineDoItYourselfPackageImpl
