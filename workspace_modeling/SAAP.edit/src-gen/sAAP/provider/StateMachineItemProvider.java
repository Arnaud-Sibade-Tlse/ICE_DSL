...
/**
 * This is the item provider adapter for a {@link sAAP.StateMachine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateMachineItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						SAAPPackage.Literals.STATE_MACHINE__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SAAPPackage.Literals.STATE_MACHINE__STATE);
			childrenFeatures.add(SAAPPackage.Literals.STATE_MACHINE__TRANSITION);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case SAAPPackage.STATE_MACHINE__NAME:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case SAAPPackage.STATE_MACHINE__STATE:
		case SAAPPackage.STATE_MACHINE__TRANSITION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(SAAPPackage.Literals.STATE_MACHINE__STATE, SAAPFactory.eINSTANCE.createState()));

		newChildDescriptors.add(createChildParameter(SAAPPackage.Literals.STATE_MACHINE__TRANSITION,
				SAAPFactory.eINSTANCE.createTransition()));
	}
